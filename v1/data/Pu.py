...
{W}[{R}*{W}]{G} forced X {R}Brute force {P}v1\033[40m\033[1;30m Bay issam iso{W}
''')
list=[]
...
def getform(url):
	...
	try:
		...
		sys.exit()
def Pu(url,username,password,formuser,formpass,keyfalse,keytrue):
	ban()
	...
	try:
		...
		sys.exit()
	#user=open('username.txt','r').readlines()
